...
const words = [
  {
    id: 1,
    word: "forgotten",
    definition: "verb (past participle of 'forget'). Something that is not remembered anymore.",
  },
  {
    id: 2,
    word: "forgetting",
  ...
  },
  {
    ...
    word: "preferring",
    definition:
      "verb. Participle/progressive tense meaning 'choosing one thing rather than another'.",
  },
  {
    id: 7,
    word: "gardening",
    definition:
      "meaning 1 - adjective meaning 'related to the garden'. Meaning 2 - noun meaning 'taking care of the garden'. Meaning 3 - the participle/progressive tense of 'to garden'.",
  },
  {
    id: 8,
    word: "limiting",
  ...
  },
  {
    ...
    word: "physical",
    definition:
      "meaning 1 - adjective meaning 'relating to movement, or objects you can see, feel, or touch in the real world. meaning 2 - noun meaning 'a medical examination'.",
  },
  {
    id: 16,
    word: "crystal",
    definition:
      "noun. A shiny, clear rock that forms in shapes and reflects light, often used for jewellery or decorations.",
  },
  {
    id: 17,
    word: "rhythm",
    definition: "abstract noun. A pattern of beats or sounds that repeat in music or poetry.",
  },
  {
    id: 18,
    word: "young",
    definition: "can be used as a adjective or noun. Antonym of 'old'",
  },

  {
    id: 19,
    word: "double",
    definition: "can be used as an adverb, adjective, noun or verb. Means 'twice as much or having two of something'.",
  },

  {
    ...
    word: "country",
    definition:
      "noun. A place where people live, with its own government, land, and culture.",
  },
  {
    id: 21,
    word: "encourage",
    definition:
      "verb. To give support or praise to someone to help them feel confident and motivated.",
  },

  {
    ...
    word: "borough",
    definition:
      "noun. A small town or district within a larger city, like a neighborhood with its own identity.",
  },
  {
    id: 23,
    word: "enormous",
    definition:
      "adjective. Exceptionally large, like a huge crocodile or an immense skyscraper.",
      spelling_rule: 46,
    },  
  {
    id: 24,
    word: "enough",
    definition: "can be used as an adverb, determiner, pronoun or interjection. Means 'a sufficient amount'.",
  },

  {
    ...
    word: "tough",
    definition:
      "can be used as a noun, adjective, interjection or verb. Means 'hard to do or endure, or a person or thing that shows strength, effort, or resilience'.",
    spelling_rule: 59,
  },

  {
    id: 26,
    word: "colour",
    definition: "can be used as a noun or verb. A shade, hue or tint such as red, blue or green.",
  },

  {
    ...
    word: "favour",
    definition:
      "can be used as a noun or verb. An act of kindness or help shown to someone, like doing a task that someone has asked you to do.",
  },

  {
    ...
    word: "flavour",
    definition:
      "can be used as a noun or verb. The taste of something, like sweetness, sourness, or spiciness, making food enjoyable.",
  },
  ...
  },
  {
    ...
    word: "exploration",
    definition:
      "abstract noun. Discovering new places or ideas, often through travelling, research, or investigation.",
  },
  {
    id: 46,
    word: "admission",
  ...
  },
  {
    ...
    word: "chemistry",
    definition:
      "noun. The study of the properties of atoms and matter.",
    spelling_rule: 48,
  },
  {
    id: 165,
    word: "choir",
    definition:
      "noun. A group of singers who sing together, particularly at a church.",
    spelling_rule: 48,
  },
  {
    id: 166,
